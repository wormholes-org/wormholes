...
func (ist *IstanbulExtra) DecodeRLP(s *rlp.Stream) error {
	...
	ist.Validators, ist.Seal, ist.CommittedSeal, ist.ExchangerAddr, ist.ValidatorAddr, ist.RandomHash, ist.RewardList = istanbulExtra.Validators, istanbulExtra.Seal, istanbulExtra.CommittedSeal, istanbulExtra.ExchangerAddr, istanbulExtra.ValidatorAddr, istanbulExtra.RandomHash, istanbulExtra.RewardList
	return nil
}
