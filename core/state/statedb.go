...
func (s *StateDB) IntermediateRoot(deleteEmptyObjects bool) common.Hash {
	...
	for addr := range s.stateObjectsPending {
		if obj := s.stateObjects[addr]; obj.deleted {
			...
			//log.Info("caver|IntermediateRoot|deleteStateObject", "s.originalRoot", s.originalRoot, "addr", addr.String(), "triehash", s.trie.Hash().String(), "benefiaddr", obj.data.Owner.Hex(), "len", len(s.stateObjectsPending))
		} else {
			s.updateStateObject(obj)
			//log.Info("caver|IntermediateRoot|updateStateObject", "s.originalRoot", s.originalRoot, "addr", addr.String(), "triehash", s.trie.Hash().String(), "benefiaddr", obj.data.Owner.Hex(), "len", len(s.stateObjectsPending))
		}
