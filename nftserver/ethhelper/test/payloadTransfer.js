...
const contracts = require("./NFT721.json")
...
async function payload() {
    try {
        ...
        const input = contract.methods.transferFrom(from,"0x10CEc672c6BB2f6782BEED65987E020902B7bD15",147253).encodeABI()
        let nonce = 0;
        ...
        for (let i=0;i<ret.logs.length;i++){
            console.log(ret.logs[i])
            console.log(ret.logs[i].topics)
        }
    }catch (e) {
        console.log(e)
    }
