...
func NewSet(addrs []common.Address, policy *istanbul.ProposerPolicy, db *state.StateDB, totalValset *types.ValidatorList) istanbul.ValidatorSet {
	return newDefaultSet(addrs, policy, db, totalValset)
}
